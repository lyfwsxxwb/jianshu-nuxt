            ...
            <div class="comment">
                ...
                <div class="comment-wrap">
                    ...
                    <div class="tool-group">
                        <a :class="[isZan?'liked-btn like-btn':'like-btn']" @click="isZan=!isZan" >
                            <span>29人赞</span>
                        </a>
...
.comment-list .comment .comment-wrap .liked-btn::before {
  animation: zans 0.6s steps(19) forwards;
}
@keyframes zans {
  from {
